...
The CANBench Duo PCB sits inside a **Yongu YG-H10A extruded aluminium split enclosure** with black anodised finish. The extrusion forms the top and bottom faces; two vertical aluminium faceplates close the front and back. The PCB slides into milled grooves in the extrusion. The housing described here corresponds to the V1.1 fabricated prototype, the sole built unit.
