...
The CANBench Duo V1.1 BOM, grouped by Value. Sources are sample suppliers; substitute equivalents permitted where noted in [Circuit Design](../circuit-design/index.md).
