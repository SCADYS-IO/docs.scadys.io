...
![CANBench Duo enclosure — isometric view](/img/canbench-duo-v1.1/render_1.PNG)
...
The values below are design intent. They have been calculated from datasheet specs against the V1.1 fabricated topology; empirical confirmation via thermal and VNA testing is pending.
