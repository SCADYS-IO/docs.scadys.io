...
* a 5.3 V DC-DC converter (VPP) used for display, buzzer, and other 5 V loads;
...
The digital domain includes the main microcontroller and all logic-level circuitry. It is powered by the VPP and VCC rails provided by the SMPS domain. This domain includes:
