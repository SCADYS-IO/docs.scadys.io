...
The MDD400 integrates a 480 × 480 pixel capacitive touch TFT HMI display for its user interface. The display is based on the [DWIN DMG48480F040_01WTC](../../assets/pdf/DMG48480F040_01WTC_Datasheet.pdf) module and communicates with the ESP32-S3 via [`UART2`](../../quick_reference.md). The display has a fixed 50-pin [flat flex cable (FFC)](https://en.xunpu.com.cn/product/388.html) connection, but only the power and UART pins ([`DISP_RX`](../../quick_reference.md) and [`DISP_TX`](../../quick_reference.md)) are connected. All other signals are left unconnected. 
...
The MOSFET (Q6) is pulled high by R33 and controlled by an NPN transistor (Q7, [S8050](https://lcsc.com/datasheet/lcsc_datasheet_2308071512_JSMSEMI-SS8050_C916392.pdf)). When the [`DISP_EN`](../../quick_reference.md) line is driven high by the ESP32, Q7 turns on and pulls the gate of Q6 low, enabling `VDSP`. Local decoupling is provided by 100 nF and 10 µF capacitors (C48, C49).
...
3. DWIN, [*DMG48480F040_01WTC Capacitive Touch Display Datasheet*](../../assets/pdf/DMG48480F040_01WTC_Datasheet.pdf)
