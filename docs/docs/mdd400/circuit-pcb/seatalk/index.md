...
The legacy interface accepts a single bidirectional signal line (ST\_SIG), which is filtered and protected before being interfaced with the internal logic domain. 
