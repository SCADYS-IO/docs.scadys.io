...
There are three connections to the MDD400 microcontroller GPIO pins: UART RX, UART TX and ST\_EN (transmit enable). All three connections are galvanically isolated using [TLP2309 high-speed logic gate opto-isolators](https://toshiba.semicon-storage.com/ap-en/semiconductor/product/isolators-solid-state-relays/detail.TLP2309.html).
