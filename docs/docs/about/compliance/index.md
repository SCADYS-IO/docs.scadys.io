...
Compliance requirements depend on how a product is supplied: as a finished retail unit, as a kit, or as a PCB for DIY assembly. The matrix below summarises which regimes typically apply to SCADYS.IO products in each case. Use the requirement‑specific pages for scope, obligations, and record‑keeping.
