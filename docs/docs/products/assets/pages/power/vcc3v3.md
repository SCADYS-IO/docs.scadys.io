The 3.3 V regulated power is generated from the 12 V input rail (`VSD`) using a high-efficiency synchronous buck converter based on the [Texas Instruments LMR51610](https://www.ti.com/lit/ds/symlink/lmr51610.pdf). Key design requirements include:
...
* support peak output current of up to 275 mA;
...
The circuit schematic for the 3.3 V DC-DC converter is based on the Texas Instruments [WEBENCH design](../../pdf/vcc_design_report.pdf).

![VCC DC-DC schematic](../../images/vcc_schematic.png)
...
Simulated performance (WEBENCH) with nominal 12 V input and continuous 275 mA output:
