...
![Serial Receive Buffer](../../images/seatalk_rx.png)
...
The output of the opto-isolator is pulled up to `VCC` (3.3 V) via a 2.2 kΩ resistor and filtered with a 100 nF capacitor. This produces a logic-compatible signal on the MCU receive pin (`ST_RX`).
