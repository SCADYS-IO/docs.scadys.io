...
The ESP32-S3-WROOM-1 module includes [48 GPIOs](https://docs.espressif.com/projects/esp-idf/en/v5.5/esp32s3/api-reference/peripherals/gpio.html), many of which are multifunctional. The following GPIO assignments are used in the WTI400:
