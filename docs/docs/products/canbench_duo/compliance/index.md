...
- accredited EMC compliance laboratories and large manufacturers for certified testing;
- makers, small businesses, and engineering teams performing pre-compliance evaluation;
- DIY users and hobbyists building their own test equipment.

## Product options
- compliance lab grade (fully certified and calibrated instrument);  
- pre-compliance grade (assembled unit, uncertified and uncalibrated);  
- complete build kit (unassembled kit with PCB populated with SMD components); and  
