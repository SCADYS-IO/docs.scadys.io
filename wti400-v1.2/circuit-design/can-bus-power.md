...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_bus_power_fe47eba4.svg" alt="CAN bus power — full sheet" />
...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_bus_power_fe47eba4.svg" alt="CAN domain power conditioning — TVS/MOV clamp, fuse + reverse-polarity Schottky, bulk caps, two-stage LC EMI filter. Zoom out to see the full sheet." initialFocus="12.7 12.7 147.32 88.9" />
...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_bus_power_fe47eba4.svg" alt="Over-voltage protection — Q2 high-side switch, Q3 comparator, R27/R28 divider, R25/R26 gate network, C28 hysteresis, D3 gate clamp, D2 secondary clamp. Zoom out to see the full sheet." initialFocus="160.02 12.7 124.46 88.9" />
