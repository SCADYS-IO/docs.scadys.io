...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_transceiver_fc3efebb.svg" alt="CAN transceiver — full sheet" />
...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_transceiver_fc3efebb.svg" alt="NMEA 2000 Connector and Shield block — J2 Micro-C panel-mount socket, shield handling. Zoom out to see the full sheet." initialFocus="0 92 152 108" />
...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_transceiver_fc3efebb.svg" alt="CAN Filter and ESD Protection block — U9 TVS, FL1 common-mode choke, C24–C27 filter caps. Zoom out to see the full sheet." initialFocus="0 0 152 108" />
...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_transceiver_fc3efebb.svg" alt="CAN Transceiver block — U5 SN65HVD234DR transceiver, R14–R17 configuration resistors. Zoom out to see the full sheet." initialFocus="145 0 152 108" />
...
<SchematicViewer src="/img/schematics/wti400-v1.2/can_transceiver_fc3efebb.svg" alt="Vcc Supply Decoupling block — C18 bulk + C19 HF bypass at U5 VCC pin. Zoom out to see the full sheet." initialFocus="145 92 152 108" />
