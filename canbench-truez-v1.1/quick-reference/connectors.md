...
![CANBench TrueZ input faceplate — LISN+ and LISN− SMA jacks](/img/canbench-truez-v1.1/faceplate_inputs.svg)

**Output face — CM / DM outputs (to the analyser)**

![CANBench TrueZ output faceplate — DM-100 Ω and CM-25 Ω SMA jacks](/img/canbench-truez-v1.1/faceplate_outputs.svg)
