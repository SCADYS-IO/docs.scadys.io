...
This section only notes loads supplied by the V<sub>SS</sub> domain. The 12 V circuit implementation is fully described in [Power Conditioning](../protection_emc/index.md).
