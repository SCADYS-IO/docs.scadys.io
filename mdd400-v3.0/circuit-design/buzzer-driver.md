...
The V3.0 audio/alerting approach — the simple **PWM buzzer** versus **PDM WAV playback** — is an **open design decision**. This page is on hold pending that call.

This page will be generated from the V3.0 schematic during capture. See the [Tasks](/mdd400/v3.0/tasks) page for status.
