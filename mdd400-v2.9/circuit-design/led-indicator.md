...
<SchematicViewer src="/img/schematics/mdd400-v2.9/esp32_module_7c3ce4f1.svg" alt="Status LED sub-circuit — Q1 (BC807-25 PNP high-side switch), D2 (amber 0603 LED), R8 (base-bias resistor), R15 (base pull-down to GNDREF), R14 (LED current-limit). Default-on by hardware bias; firmware-controlled via LED_EN." initialFocus="146.05 88.9 137.16 74.93" />
