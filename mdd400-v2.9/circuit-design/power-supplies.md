...
<SchematicViewer src="/img/schematics/mdd400-v2.9/power_supplies_010cbf99.svg" alt="MDD400 Power Supplies schematic (full sheet) — VDD converter top-left, VCC converter top-right, Isolation of Power Domains sub-diagram lower-left" />
...
<SchematicViewer src="/img/schematics/mdd400-v2.9/power_supplies_010cbf99.svg" alt="Isolation of Power Domains (MDD400) — FB4 input ferrite at SMPS boundary, FB1/FB2 output ferrites per rail with 100 pF rail bypass at each ferrite pad. Zoom out to see the full sheet." initialFocus="12.7 90.17 135.89 106.68" />
