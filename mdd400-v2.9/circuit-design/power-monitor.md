...
<SchematicViewer src="/img/schematics/mdd400-v2.9/i2c_sensors_37ef56ec.svg" alt="INA219 power monitor sub-circuit — U2 (TI INA219AIDCNR), R33 (Yageo 330 mΩ precision thick-film shunt, located in the power supply section), C8 (1 µF VCC bulk bypass), and C11 (100 nF VCC HF bypass)." initialFocus="152.4 12.7 130.81 88.9" />
