...
<SchematicViewer src="/img/schematics/mdd400-v2.9/can_bus_power_c9042393.svg" alt="CAN bus power — full sheet" />
...
<SchematicViewer src="/img/schematics/mdd400-v2.9/can_bus_power_c9042393.svg" alt="CAN domain power conditioning — TVS/MOV clamp, fuse + reverse-polarity Schottky, bulk caps, two-stage LC EMI filter. Zoom out to see the full sheet." initialFocus="12.7 12.7 147.32 88.9" />
